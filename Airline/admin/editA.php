...
<body>
	...
	<form name="form" method="POST" action="saveA.php">
	<?php include('../include/valid2.php'); ?>
	<h3>Update Personal Details</h3>
	<hr>
		<table border="0">
			<tr>
				<td width="200"> ID Worker: </td>
				<td> <?php echo $row[15]; ?> </td>
			</tr>
			<tr>
				<td width="200"> Department: </td>
				<td> <input type="text" name="department" value="<?php echo $row[14]; ?>" required /> </td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td> <input type="button" name="pass" value=" Change Password? " onClick="window.location.href='password.php'" /> </td>
			</tr>
			<tr>
				<td width="200"> Date of Birth: (dd/mm/yy)</td>
			...
			<tr>
				...
				<option value="<?php echo $row[7]; ?>" required><?php echo $row[7]; ?> </option>
